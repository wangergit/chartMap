...
var controlTemplate = _.template("<a class=\"<%= model.className %>-toggle js-toggle\" href=\"#\" title=\"测量距离和面积\">测量</a>\n<div class=\"<%= model.className %>-interaction js-interaction\">\n  <div class=\"js-startprompt startprompt\">\n    <h3 style=\"color:#5E66CC\">距离和面积测量工具</h3>\n    <ul class=\"tasks\">\n      <a href=\"#\" class=\"js-start start\">开始测量</a>\n    </ul>\n  </div>\n  <div class=\"js-measuringprompt\">\n    <h3 style=\"color:#5E66CC\">距离和面积测量工具</h3>\n    <p class=\"js-starthelp\"><font style=\"line-height:150%;\">说明：<br>&nbsp;&nbsp;1.点击地图开始测量<br>&nbsp;&nbsp;2.点击完成保存结果<br>&nbsp;&nbsp;3.点击取消则不保存</font></h3>\n    <div class=\"js-results results\"></div>\n    <ul class=\"js-measuretasks tasks\">\n      <li><a href=\"#\" class=\"js-cancel cancel\">取消</a></li>\n      <li><a href=\"#\" class=\"js-finish finish\">完成</a></li>\n    </ul>\n  </div>\n</div>");
var resultsTemplate = _.template("<div class=\"group\">\n<p class=\"lastpoint heading\">上一点:</p>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n</div>\n<% if (model.pointCount > 1) { %>\n<div class=\"group\">\n<p><span class=\"heading\">距离:</span> <%= model.lengthDisplay %></p>\n</div>\n<% } %>\n<% if (model.pointCount > 2) { %>\n<div class=\"group\">\n<p><span class=\"heading\">面积:</span> <%= model.areaDisplay %></p>\n</div>\n<% } %>");
var pointPopupTemplate = _.template("<h3>点位置</h3>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n<!--ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">居中</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">删除</a></li>\n</ul-->");
var linePopupTemplate = _.template("<h3>两点距离</h3>\n<p><%= model.lengthDisplay %></p>\n<!--ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">居中</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">删除</a></li>\n</ul-->");
var areaPopupTemplate = _.template("<h3>范围测量结果</h3>\n<p><%= model.areaDisplay %></p>\n<p><%= model.lengthDisplay %> 周长</p>\n<!--ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">居中</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">删除</a></li>\n</ul-->");
...
L.Control.Measure = L.Control.extend({
  ...
  _expand: function () {
    ...
    $('.aj-jiantou')?$('.aj-jiantou').click():null;
  },
  _collapse: function () {
    if (!this._locked) {
